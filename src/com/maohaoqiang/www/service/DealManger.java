...
public class DealManger {
    public static boolean manger( boolean decide, Map<String,String> userlogin){
        String fun2="";
        UserDaoImpl userDao=new UserDaoImpl();
                ...
                while (decide){
                    if(fun2.equalsIgnoreCase("查看用户")||fun2.equalsIgnoreCase("1")||
                            ...
                            fun2.equalsIgnoreCase("退出")||fun2.equalsIgnoreCase("4")){
                        if(fun2.equalsIgnoreCase("查看用户")||fun2.equalsIgnoreCase("1")){
                        ...
                        if (fun2.equalsIgnoreCase("退出")||fun2.equalsIgnoreCase("4"))Out.exit();
                    }
                }
        return decide;
    }
